...
- (UIView *)headerViewForTitle:(NSString *)title inTableView:(UITableView *)tableView leftMargin:(NSInteger)leftMargin  separatorMargin:(NSInteger)separatorMargin {
	SRSectionedTableHeaderView *cell = (SRSectionedTableHeaderView *)[tableView dequeueReusableHeaderFooterViewWithIdentifier:[self defaultHeaderReuseIdentifier]];
...
- (void)registerWithTableView:(UITableView *)tableView {
	...
	if (nib) {
		...
		nib = [UINib nibWithNibName:@"SRSectionedTableHeaderView" bundle:nil];
		[tableView registerNib:nib forHeaderFooterViewReuseIdentifier:identifier];
	}
}
